...
Currently `kaca` only supports windows platforms and does bad for relative paths support In the future, I will study python's [PIL project](https://github.com/python-pillow/Pillow) and explore how to support multiple platforms.
